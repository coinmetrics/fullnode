...
let
  ...
  boost' = (boost.override {
    ...
    patches = old.patches ++ [
      (fetchpatch {
        url = "https://raw.githubusercontent.com/zcash/zcash/v6.1.0/depends/patches/boost/6753-signals2-function-fix.patch";
        stripLen = 0;
...
rustPlatform.buildRustPackage.override { stdenv = clangStdenv; } rec {
  ...
  src = fetchFromGitHub {
    ...
    repo  = "zcash";
    rev = "v${version}";
    hash = "sha256-ozPRyCfOQsaHWnDWnmIsTOccCOnWh2OFa2zlRLM8+Qs=";
  };

  cargoHash = "";

  cargoLock = {
    lockFile = ./6.1.0-Cargo.lock;
  };
